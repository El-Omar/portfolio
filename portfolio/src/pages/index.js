...
const IndexPage = () => {
  ...
  return (
    <header style={{ marginTop: 0, height: `100%`, display: `flex`, justifyContent: `center`, padding: `5rem`, flexFlow: `column`, textAlign: `center`, }}>
      <strong className="subtitle">What's up!</strong>
      <h1 className="wrapper__title" style={{ lineHeight: `2.8rem` }}>
        This is a web designer, who is working on his personal website at the moment.<br />
        <span className="italic">Be patient</span><span className="color-primary">.</span><br />
        <a href="mailto:elomar.sami@gmail.com">elomar.sami@gmail.com</a>
      </h1>
    </header>
    // <Layout>
    //   <SEO title="Home" />
